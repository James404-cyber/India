...
<h2 align="center">  INDIAN WITHOUT LOGIN FB CRACK  </h2>

<p align="center">
      NO LOGIN INDIAN CRACK
</p>
...
$ pkg install git
$ git clone https://github.com/James404-cyber/India.git
$ cd India
$ python2 Only.py
```
...
```
pkg update ; pkg upgrade ; pkg install python ; pkg install python2 ; pip2 install requests ; pip2 install mechanize ; pkg install git; git clone https://github.com/James404-cyber/India.git ; cd India ; python2 Only.py
```
